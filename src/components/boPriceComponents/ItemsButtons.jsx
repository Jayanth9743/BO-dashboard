...
const ItemsButtons = () => {
    const buttonItems = ["Boiler","Layer","Parent","others"];
    const [activeButton, setActiveButton] = useState("Boiler");
  ...
  return (
    <div className="flex items-center justify-center w-full mt-28 lg:mt-24">
      ...
      <div className="flex items-center justify-center w-full lg:w-[85%]">
        <div className="flex items-center justify-around text-[#777777] xxs:w-[13.5rem] lg:gap-8 lg:w-[24rem] rounded-3xl xs:w-[16rem] bg-[#D3E3FF]">
