...
const ProfitTable = () => {
  return (
    <div className='flex items-center justify-center w-full ml-2 overflow-x-auto lg:w-full lg:ml-0 hide-scrollbar'>
      <TableContainer component={Paper} sx={{bgcolor:"#DDDDDD", flexShrink:0}}>
      <Table>
        {/* Table Header */}
        <TableHead>
          <TableRow>
